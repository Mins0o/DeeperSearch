...
def select_directory(view_tempResult):
	if view_tempResult:
		out_most = "../tempResults/"
		cut = -7
	else:
		out_most = "../Results/"
		cut = -1
...
def spec2sig(spec, name, sr, n):
    ...
    newDir = '../Results/Audio_Results/audio_from_spec'
...
if __name__ == "__main__":
	view_tempResult = bool(int(input("0: View Organized Results\n1: View tempResult\n>>> ")))
	directory = select_directory(view_tempResult)
	...
	print("\nSaved to '../Results/Audio_Results/audio_from_spec'")
